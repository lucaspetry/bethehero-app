        ...
        <View style={style.container}>
            <View style={style.header}>
                ...
                <Text style={style.headerText}>
                    Total of <Text style={style.headerTextBold}>{total}</Text> incidents.
                </Text>
            </View>

            <Text style={style.title}>Welcome!</Text>
            <Text style={style.description}>Pick one of the incidents below and help save the day.</Text>
                ...
                renderItem={({ item: incident }) => (
                    <View style={style.incident}>
                        ...
                        <TouchableOpacity style={style.detailsButton} onPress={() => navigateToDetails(incident)}>
                            <Text style={style.detailsButtonText}>See details</Text>
